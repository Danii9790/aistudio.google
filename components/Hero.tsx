...
import { DocumentTextIcon, BeakerIcon, PhotoIcon, ClipboardDocumentCheckIcon } from '@heroicons/react/24/outline';
import { ShieldCheckIcon, BoltIcon, HeartIcon } from '@heroicons/react/24/solid';
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        {/* Top Left: Labs -> Verified */}
        <div className="hidden lg:block">
            <DrawingTransformation 
            initialIcon={DocumentTextIcon} 
            finalIcon={ClipboardDocumentCheckIcon} 
            label="REPORT"
            delay={0} 
            x="4%" 
            y="8%"
        ...
        {/* Bottom Right: Vitals -> Analysis */}
        <div className="hidden md:block">
            <DrawingTransformation 
            initialIcon={HeartIcon} 
            finalIcon={ShieldCheckIcon} 
            label="HEALTH"
            delay={3000} 
            x="88%" 
            y="75%"
        ...
        {/* Bottom Left: Scan -> Findings */}
        <div className="hidden md:block">
            <DrawingTransformation 
            initialIcon={PhotoIcon} 
            finalIcon={ClipboardDocumentCheckIcon} 
            label="SCAN"
            delay={4500} 
            x="5%" 
      ...
      <div className="text-center relative z-10 max-w-6xl mx-auto px-4 pt-8">
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tighter text-white mb-6 leading-[1.1]">
          Understand your <br/>
          <span className="underline decoration-4 decoration-blue-500 underline-offset-4 md:underline-offset-8 text-white">health data</span>.
        </h1>
        <p className="text-base sm:text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed font-light">
          Gemini analyzes your medical reports, lab results, and scans to provide instant, clear explanations and potential differential diagnoses.
        </p>
      </div>
    </>
  );
